...
class Processor(ABC):
    ...
    def make_delayed(cls):
        class DelayedProcessor(cls):
            ...
            def get_description(self):
                ...
                res = "delayed processor wrapping a ({}) with a delay of {} ms".format(
                    super_desc, self.delay
                )
                return res
    ...
    def make_jittered(cls):
        class JitteredProcessor(cls):
            ...
            def get_description(self):
                super_desc = super().get_description()
                res = "jittered processor wrapping a ({}) with a jitter of {} cycles".format(
                    super_desc, self.jitter
                )
                return res
